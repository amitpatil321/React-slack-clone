...
import { getUserName, getUserPic, isPrivateChat, getUserDetails, onlineStatus } from 'utils/SlackUtils';
...
const ChannelInfoDrawer = () => {
    ...
    return <Drawer
        ...
        title={<strong>About {isPrivateChat(room) ? " this conversation" : "#" + room.name}</strong> }
        placement    = "right"
        width        = "250"
        closable     = {true}
        maskClosable = {true}
