...
import {
  Layout, Typography, Spin, Icon, Alert,
} from 'antd';
...
const ChatHome = (props) => {
  const {
    user, room, rooms, isLoading, error,
  } = props;

  if (Object.keys(user).length && Object.keys(room).length && rooms.length) {
    return (
      <>
        <Layout>
        ...
        <Content className="content">
          <div className="screen-center text-center">
            ...
            <p className="text-light">
              {`- Your friends at ${CONFIG.APP_NAME}`}
            </p>
